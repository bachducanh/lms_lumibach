...
import { ChevronUp, ChevronDown, ChevronsUpDown, ExternalLink, Trash2, Download } from 'lucide-react';
...
function exportCSV(
  ...
  const headers = [
    'Họ và tên', 'Email', 'Trạng thái',
    'Bắt đầu vào lúc', 'Được hoàn thành', 'Thời gian thực hiện',
    'Điểm/10',
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/50">
              ...
              <th className="min-w-48 px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                Họ và tên
              </th>
              <th className="min-w-44 px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                Email
              </th>
              <th className="min-w-36 px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                Trạng thái
              </th>
              ...
              {questions.map((q, idx) => (
                <th
                  key={q.questionId}
                  className="min-w-14 px-3 py-2.5 text-center text-xs font-semibold uppercase tracking-wide text-muted-foreground whitespace-nowrap"
                >

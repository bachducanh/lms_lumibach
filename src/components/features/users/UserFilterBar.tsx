...
export function UserFilterBar({ q, role, status }: Props) {
  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      />
      <select
        className="h-8 rounded-lg border border-input bg-background px-2.5 text-sm text-foreground outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-card"
        value={role}

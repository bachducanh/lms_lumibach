...
export function MarkCompleteButton({ moduleItemId, isCompleted, courseSlug: _courseSlug, lessonId: _lessonId }: Props) {
  ...
  if (isCompleted) {
    return (
      <Button size="sm" variant="ghost" onClick={handleClick} disabled={pending}
        className="text-green-600 hover:text-muted-foreground hover:bg-muted gap-1.5">

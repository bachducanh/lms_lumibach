...
export const canManageContent = (role?: UserRole) => !!role && hasMinRole(role, 'TEACHER');

/** Có thể chấm bài (admin, teacher, TA) */
export const canGrade = (role?: UserRole) => !!role && hasMinRole(role, 'TA');

/** Có thể xem tất cả submission trong khóa */
export const canViewAllSubmissions = (role?: UserRole) => !!role && hasMinRole(role, 'TA');

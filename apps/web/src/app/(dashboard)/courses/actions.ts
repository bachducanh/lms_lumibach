...
import type { CreateCourseBody, UpdateCourseBody } from '@lumibach/types';

type CoursePayload = CreateCourseBody & { thumbnail?: string };
type UpdateCoursePayload = UpdateCourseBody & { thumbnail?: string };
...
export async function deleteCourseAction(
  ...
  try {
    ...
    return { error: err instanceof ApiError ? err.message : 'Lỗi xoá khoá học' };
  }
}

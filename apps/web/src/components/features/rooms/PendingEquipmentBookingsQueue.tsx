          ...
          <li key={booking.id} className="flex items-start gap-3 px-4 py-3">
            ...
            >
              ...
              {booking.availabilityIssues.length > 0 && (
                <span className="mt-1.5 inline-flex items-center gap-1 rounded-full border border-amber-600/25 bg-amber-50 px-2 py-0.5 text-[11px] font-medium text-amber-800 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-400">

...
function registerEmmetAndTheme(
          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                onClick={() => setTab(t.id)}
                className={cn(
                  'relative flex h-full items-center gap-2 border-r border-white/10 px-4 text-xs font-medium whitespace-nowrap transition-colors',
                  active
                    ? 'bg-[#1a1a2e] text-[#f8f8f2]'
                    : 'text-[#6272a4] hover:bg-[#1a1a2e]/50 hover:text-[#f8f8f2]'
                )}
              >
        ...
        >
          ...
          {!auto && (
            <button
              ...
              className="rounded p-1 text-[#6272a4] transition-colors hover:bg-[#1a1a2e] hover:text-[#f8f8f2]"
            >

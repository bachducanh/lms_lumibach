...
const RichTextEditor = dynamic(
  ...
  {
    ssr: false,
    loading: () => <div className="bg-muted/30 h-48 animate-pulse rounded-xl" />,
  }
);
    ...
    <div>
      ...
      <div className="max-w-5xl space-y-6">
        ...
        <input
          ...
          required
          className="placeholder:text-muted-foreground/30 w-full bg-transparent text-3xl leading-tight font-bold tracking-tight outline-none"
        />
        ...
        <div
          className={cn(
            'border-border flex items-center justify-end gap-2 border-t pt-6',
            mode === 'create' ? '' : ''
          )}
        >
          <Button

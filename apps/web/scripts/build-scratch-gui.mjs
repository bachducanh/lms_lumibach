...
if (!existsSync(bundlePath)) {
  ...
  const DH_OLD =
    'var DomHandler = __webpack_require__(/*! domhandler */ "./node_modules/domhandler/lib/esm/index.js");';
...
for (const name of ['editor.js', 'embed.js', 'fullscreen.js', 'player.js']) {
  ...
  if (c.includes(SFP_MARK)) {
    ok(name + ' already patched');
    continue;
  }
  if (!c.includes(SFP_OLD)) {
    warn(name + ' has no SB3Downloader.defaultProps — skipping');
    continue;
  }
